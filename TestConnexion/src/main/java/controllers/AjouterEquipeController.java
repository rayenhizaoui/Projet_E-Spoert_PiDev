...
public class AjouterEquipeController {
    ...
    @FXML
    void jeu(ActionEvent event) throws IOException{
        Parent view4=FXMLLoader.load(getClass().getResource("/AjouterJeu.fxml"));
    ...
    @FXML
    void home1(ActionEvent event) throws IOException{
        Parent view3= FXMLLoader.load(getClass().getResource("/home.fxml"));
